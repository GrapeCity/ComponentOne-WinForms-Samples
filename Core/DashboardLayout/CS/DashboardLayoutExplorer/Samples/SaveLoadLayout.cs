...
{
    public partial class SaveLoadLayout : UserControl
    {
        ...
        {
            // init chart1
            flexChart1.DataSource = DataSource.DemoDataSource("SalesByCountry");
            flexChart1.Series.Clear();
            flexChart1.Series.Add(new Series() { Name = "Sales", Binding = "Sales" });
            flexChart1.BindingX = "Country";
            // init grid
            c1FlexGrid1.DataSource = DataSource.DemoDataSource("Sales");
            // init pie
            flexPie1.DataSource = DataSource.DemoDataSource("SalesByEmployee");
