    ...
    internal class DataHelper
    {
        ...
        public List<Product> Products
        {
            get
            {
                if (_products == null)
                {
                    var values = System.Text.Json.JsonSerializer.Serialize(GetObject("Products"));
                    _products = System.Text.Json.JsonSerializer.Deserialize<List<Product>>(values);
                }
                return _products;
            }
        }
        ...
        private object GetObject(string key)
        {
            if (_dict == null)
            {
                ...
                _dict = System.Text.Json.JsonSerializer.Deserialize<Dictionary<string, object>>(json);
            }
            return _dict[key];
        }
