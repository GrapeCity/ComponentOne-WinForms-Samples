...
namespace SqlBuilder
{
	...
	public class SqlBuilderDialog : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.ToolStripButton _tbProperties;
		private System.Windows.Forms.ToolStripSeparator _tbSep1;
		private System.Windows.Forms.ToolStripButton _tbViewResults;
		private System.Windows.Forms.ToolStripButton _tbConnString;
		private C1.Win.FlexGrid.C1FlexGrid _flex;
		private System.Windows.Forms.TreeView _tree;
		private System.Windows.Forms.TextBox _txtSql;
		private System.Windows.Forms.Splitter splitter1;
		private System.Windows.Forms.Splitter splitter2;
		private System.Windows.Forms.ToolStripButton _tbGroupBy;
		private System.Windows.Forms.ToolStripButton _tbCheckSql;
		private System.Windows.Forms.ToolStripSeparator _tbSep2;
		private System.Windows.Forms.ToolStripButton _tbClearQuery;
		private System.Windows.Forms.ImageList _imgList;
		private System.Windows.Forms.ContextMenuStrip _treeMenu;
		private System.Windows.Forms.ToolStripMenuItem _tmShowTables;
		private System.Windows.Forms.ToolStripMenuItem _tmHideTable;
		...
		private void InitializeComponent()
		{
            ...
            this._tbConnString = new System.Windows.Forms.ToolStripButton();
            this._tbProperties = new System.Windows.Forms.ToolStripButton();
            this._tbGroupBy = new System.Windows.Forms.ToolStripButton();
            this._tbSep1 = new System.Windows.Forms.ToolStripSeparator();
            this._tbCheckSql = new System.Windows.Forms.ToolStripButton();
            this._tbViewResults = new System.Windows.Forms.ToolStripButton();
            this._tbSep2 = new System.Windows.Forms.ToolStripSeparator();
            this._tbClearQuery = new System.Windows.Forms.ToolStripButton();
            ...
            this._treeMenu = new System.Windows.Forms.ContextMenuStrip();
            this._tmHideTable = new System.Windows.Forms.ToolStripMenuItem();
            this._tmShowTables = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this._toolbar.ItemClicked += new ToolStripItemClickedEventHandler(this._toolbar_ButtonClick);
            // 
            // _tbConnString
            // 
			...
			this._tbGroupBy.CheckOnClick = true;
            ...
            this._flex.EditOptions = ((C1.Win.FlexGrid.EditFlags)((C1.Win.FlexGrid.EditFlags.AutoSearch | C1.Win.FlexGrid.EditFlags.MultiCheck)));
            ...
            this._tree.ContextMenuStrip = this._treeMenu;
            ...
            // _treeMenu
            // 
            this._treeMenu.Items.AddRange(new System.Windows.Forms.ToolStripMenuItem[] {
            this._tmHideTable,
            this._tmShowTables});
            this._treeMenu.Opened += new System.EventHandler(this._treeMenu_Popup);
            // 
            // _tmHideTable
            // 
            this._tmHideTable.MergeIndex = 0;
            this._tmHideTable.Text = "Hide this table";
            this._tmHideTable.Click += new System.EventHandler(this._tmHideTable_Click);
            // 
            // _tmShowTables
            // 
            this._tmShowTables.MergeIndex = 1;
		...
		private static string PromptConnectionString(string initial, IntPtr handle)
		{
			...
			try
			{
				...
				dynamic conn = Activator.CreateInstance(Type.GetTypeFromProgID("ADODB.ConnectionClass", true));
		...
		private void _toolbar_ButtonClick(object sender, System.Windows.Forms.ToolStripItemClickedEventArgs e)
		{
			// change connection string
			if (e.ClickedItem == this._tbConnString)
			{
			...
			// show properties
			if (e.ClickedItem == this._tbProperties)
			{
			...
			if (e.ClickedItem == this._tbGroupBy)
			{
				_qb.GroupBy = this._tbGroupBy.Checked;
				_txtSql.Text = _qb.Sql;

				// show/hide GroupBy column
				_flex.Cols["GroupBy"].Visible = this._tbGroupBy.Checked;
				return;
			}

			// clear query
			if (e.ClickedItem == this._tbClearQuery)
			{
				// confirm with user
			...
			if (e.ClickedItem == this._tbViewResults || e.ClickedItem == this._tbCheckSql)
			{
				// sanity...
				...
				try
				{
					...
					if (e.ClickedItem == this._tbCheckSql)
					{
