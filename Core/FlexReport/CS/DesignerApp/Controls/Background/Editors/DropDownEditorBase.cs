...
namespace FlexReportDesignerApp.Controls.Background.Editors
{
    internal class DropDownEditorBase : C1DropDownControl
    {
        ...
        public DropDownEditorBase()
        {
            ...
            DisplayFormat.FormatType = FormatType.UseEvent;
            EditFormat.FormatType = FormatType.UseEvent;
            ParseInfo.FormatType = FormatType.UseEvent;
        ...
        /// <summary>
        /// Should be overridden in devices class and convert string to value.
        /// </summary>
        /// <param name="e"></param>
        /// <returns></returns>
        protected virtual bool TextToValue(TextToValueArgs e)
        {
            throw new Exception("TextToValue() should be overridden in derived class.");
        }

        protected override void OnParsing(ParseEventArgs e)
        {
            if (SuppressTextInput)
            {
                // this is read only control like ImageEdit, BackgroundEdit, text
        ...
        protected virtual HitTestEx GetHitTest(MouseEventArgs e)
        {
        ...
        protected virtual void DrawIcon(Graphics g, Rectangle bounds)
        {
        }
        ...
        {
            object value;
            if (ParseContent(out value, ErrorInfo) != ErrorReason.None)
                return null;
            return value;
        }
        ...
        internal virtual void SetEditorValue(object value)
        {
            Value = value;
            Refresh();
        }
        ...
        protected DropDownForm DropDownForm
        {
            get
            {
                ...
                {
                    _dropDownForm = (DropDownForm)base.CreateDropDownForm();
                }
        ...
        protected class ValueToTextArgs
        {
            ...
            private readonly FormatTarget _target;

            #region Constructors
            public ValueToTextArgs(object value, FormatTarget target)
            {
                _value = value;
                _text = null;
                _target = target;
        ...
        /*
        public override void C1EditorInitialize(object value, System.Collections.IDictionary attrs)
        {
