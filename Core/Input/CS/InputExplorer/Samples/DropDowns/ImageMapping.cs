...
{
    public partial class ImageMapping : UserControl
    {
        Hashtable ht;
        private C1.Win.Input.C1DropDownControl _imageMappingDropDown;
        public ImageMapping(C1.Win.Input.C1DropDownControl imageMappingDropDown)
        {
            InitializeComponent();
            pictureBox1.Width = imageMappingDropDown.Width;
            _imageMappingDropDown = imageMappingDropDown;
        }
        ...
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (ht.ContainsKey(c))
            {
                _imageMappingDropDown.Value = ht[c].ToString();
                //CloseDropDown();
            }
            else
            {
                _imageMappingDropDown.Value = "None Selected";
            }
        }
