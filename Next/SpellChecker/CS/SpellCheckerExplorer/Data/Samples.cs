...
The support includes underlining errors with red-wavy underlines as you type, with suggestions in context-sensitive menus, and also the dialog-based modal spell-check.",
            ...
            _allItems.Add(new SampleItem("CustomParser",
                "Custom Parser",
...
Custom parsers are classes that implement the ISpellParser interface.",
            ...
            _allItems.Add(new SampleItem("Spell-Checking Components",
                "Spell-Checking Components",
                @"This demo uses C1SpellChecker to check spelling in a data grid. C1SpellChecker can provide active spell-checking for a variety of components including TextBox, RichTextBox and WebBrowser. This demo shows that we can implement a wrapper class for the ISpellCheckable interface to provide active spell-checking for a grid too.",
                typeof(SpellCheckerExplorer.Samples.SpellChecker.SpellGrid)));
        }
