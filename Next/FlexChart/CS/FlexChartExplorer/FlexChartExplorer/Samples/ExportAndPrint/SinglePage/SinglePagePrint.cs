...
{
    public partial class SinglePagePrint : FlexChartBaseSample
    {
        ...
        private SinglePagePrintControl _singlePagePrintControl;
        private FlexChart flexChart1;

        public SinglePagePrint()
        {
            InitializeComponent();
        }
        ...
        protected override void InitializeControls()
        {
            ...
            _singlePagePrintControl = new SinglePagePrintControl(flexChart1) {Dock= DockStyle.Bottom};
