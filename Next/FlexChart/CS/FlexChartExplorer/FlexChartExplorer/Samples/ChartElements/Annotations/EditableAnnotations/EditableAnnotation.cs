...
namespace FlexChartExplorer.Samples
{
    public partial class EditableAnnotation : FlexChartBaseSample
    {
        ...
        private ContextMenuStrip _flexChartContextMenu;
        ...
        private void FlexChart1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if(e.Button == MouseButtons.Right)
            {
                ...
                {
                    this.flexChart1.ContextMenuStrip = _flexChartContextMenu;
                    this.flexChart1.ContextMenuStrip.Show(flexChart1, e.Location);
                }
                else
                    this.flexChart1.ContextMenuStrip = null;
            }
        }
        ...
        protected override void InitializeControls()
        {
            ...
            //Context Menu
            _flexChartContextMenu = new ContextMenuStrip();
            _flexChartContextMenu.Items.Add("Delete", null, OnDeleteClicked);
