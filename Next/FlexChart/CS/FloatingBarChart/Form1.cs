using FloatingBarChart.Samples;
using System;
...
namespace FloatingBarChart
{
    public partial class MainForm : Form
    {
        ...
        string[] menuButtons = 
        {
            "FLOATING BAR", "GANTT CHARTS", "CUSTOMIZED GANTT" ,"RANGED AREA"
        };
        public MainForm()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (str)
            {
                case "FLOATING BAR": newControl = new FloatBar(); break;
                case "GANTT CHARTS": newControl = new Gantt(); break;
                case "CUSTOMIZED GANTT": newControl = new CustomizedGannt(); break;
                case "RANGED AREA": newControl = new RangedArea(); break;
                default: newControl = new FloatBar(); break;
            }
