using FlexChartCustomization.Samples;
using System;
...
namespace FlexChartCustomization
{
    public partial class MainForm : Form
    {
        ...
        string[] menuButtons = 
        {
            "LINE STYLES", "LEGEND ITEMS", "LEGEND RANGES"
        };
        public MainForm()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (str)
            {
                case "LINES": newControl = new LineStyles(); break;
                case "LEGEND ITEMS": newControl = new LegendItems(); break;
                case "LEGEND RANGES": newControl = new LegendRanges(); break;
                default: newControl = new LineStyles(); break;
            }
