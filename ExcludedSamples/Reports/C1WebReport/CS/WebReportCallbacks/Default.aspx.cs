...
namespace WebReportCallbacks
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            C1WebReport1.Paged = CheckBox2.Checked;
            C1WebReport1.EnableCallback = CheckBox1.Checked;
            C1WebReport1.CallbackWaitControlID = DropDownList1.SelectedIndex == 0 ? "" : DropDownList1.SelectedValue;
            C1WebReport1.CallbackWaitImageUrl = DropDownList2.SelectedValue;
        }
