...
Partial Class PageRuler
    ...
    Private Sub InitializeComponent()
        ...
        Dim CommonBorder1 As C1.Win.C1Gauge.CommonBorder = New C1.Win.C1Gauge.CommonBorder
        Dim CommonBorder2 As C1.Win.C1Gauge.CommonBorder = New C1.Win.C1Gauge.CommonBorder
        Dim CommonBorder3 As C1.Win.C1Gauge.CommonBorder = New C1.Win.C1Gauge.CommonBorder
        ...
        Dim CommonShape1 As C1.Win.C1Gauge.CommonShape = New C1.Win.C1Gauge.CommonShape
        ...
        Dim C1GaugePointer1 As C1.Win.C1Gauge.C1GaugePointer = New C1.Win.C1Gauge.C1GaugePointer
        Dim C1GaugePointer2 As C1.Win.C1Gauge.C1GaugePointer = New C1.Win.C1Gauge.C1GaugePointer
        ...
        Me.rulerGauge = New C1.Win.C1Gauge.C1LinearGauge
        ...
        Me.c1Gauge1.Gauges.AddRange(New C1.Win.C1Gauge.C1GaugeBase() {Me.rulerGauge})
        ...
        Me.rulerGauge.CommonBorders.AddRange(New C1.Win.C1Gauge.CommonBorder() {CommonBorder1, CommonBorder2, CommonBorder3})
        ...
        Me.rulerGauge.CommonFillings.AddRange(New C1.Win.C1Gauge.CommonFilling() {CommonFilling1, CommonFilling2, CommonFilling3})
        CommonShape1.EndAngle = 45
        CommonShape1.EndWidth = 50
        CommonShape1.Name = "SimplePointer"
        CommonShape1.StartWidth = 50
        Me.rulerGauge.CommonShapes.AddRange(New C1.Win.C1Gauge.CommonShape() {CommonShape1})
        ...
        Me.rulerGauge.Decorators.AddRange(New C1.Win.C1Gauge.C1GaugeDecorator() {C1GaugeRange1, C1GaugeLabels1, C1GaugeMarks1, C1GaugeMarks2, C1GaugeMarks3, C1GaugeRange2})
        ...
        Me.rulerGauge.FaceShapes.AddRange(New C1.Win.C1Gauge.C1GaugeBaseShape() {C1GaugeRectangle1})
        ...
        Me.rulerGauge.MorePointers.AddRange(New C1.Win.C1Gauge.C1GaugePointer() {C1GaugePointer1, C1GaugePointer2, C1GaugePointer3, C1GaugePointer4, C1GaugePointer5})
    ...
    Private WithEvents rulerGauge As C1.Win.C1Gauge.C1LinearGauge
