...
Partial Class PageCarDashboard
    ...
    Private Sub InitializeComponent()
        ...
        Dim C1GaugeRange7 As C1.Win.Gauge.C1GaugeRange = New C1.Win.Gauge.C1GaugeRange
        Dim C1GaugeMarks4 As C1.Win.Gauge.C1GaugeMarks = New C1.Win.Gauge.C1GaugeMarks
        Dim C1GaugeSingleLabel4 As C1.Win.Gauge.C1GaugeSingleLabel = New C1.Win.Gauge.C1GaugeSingleLabel
        Dim C1GaugeLabels3 As C1.Win.Gauge.C1GaugeLabels = New C1.Win.Gauge.C1GaugeLabels
        Dim C1GaugeSingleLabel5 As C1.Win.Gauge.C1GaugeSingleLabel = New C1.Win.Gauge.C1GaugeSingleLabel
        ...
        Dim C1GaugeRange8 As C1.Win.Gauge.C1GaugeRange = New C1.Win.Gauge.C1GaugeRange
        ...
        C1GaugeRange5.Gradient.Direction = C1.Win.Gauge.C1GaugeGradientDirection.RadialInner
        C1GaugeRange5.Gradient.Falloff = C1.Win.Gauge.C1GaugeGradientFalloff.SigmaBell
        ...
        C1GaugeRange6.Alignment = C1.Win.Gauge.C1GaugeAlignment.Out
        C1GaugeRange6.Border.Color = System.Drawing.Color.LightCoral
        C1GaugeRange6.Location = 95
        C1GaugeRange6.Location2 = 35
        C1GaugeRange6.ValueColors.AddRange(New C1.Win.Gauge.C1GaugeValueColor() {New C1.Win.Gauge.C1GaugeValueColor(-90, -1, System.Drawing.Color.FromArgb(CType(CType(224, Byte), Integer), CType(CType(224, Byte), Integer), CType(CType(224, Byte), Integer)), 1, CType(676529226475175784, Long)), New C1.Win.Gauge.C1GaugeValueColor(-40, -1, System.Drawing.Color.PaleGreen, 1, CType(677936611759773970, Long)), New C1.Win.Gauge.C1GaugeValueColor(-25, -1, System.Drawing.Color.LightSalmon, 1, CType(678218087732741609, Long)), New C1.Win.Gauge.C1GaugeValueColor(-7, -1, System.Drawing.Color.IndianRed, 1, CType(677655136309166209, Long)), New C1.Win.Gauge.C1GaugeValueColor(0, -1, System.Drawing.Color.SteelBlue, 1, CType(678499567948351913, Long)), New C1.Win.Gauge.C1GaugeValueColor(70, -1, System.Drawing.Color.MidnightBlue, 1, CType(678781044024275440, Long)), New C1.Win.Gauge.C1GaugeValueColor(180, -1, System.Drawing.Color.IndianRed, 1, CType(677373661041038885, Long))})
        ...
        C1GaugeMarks4.Filling.BrushType = C1.Win.Gauge.C1GaugeBrushType.Gradient
        ...
        C1GaugeRange8.AntiAliasing = C1.Win.Gauge.C1GaugeRangeAntiAliasing.LowQuality
        ...
        C1GaugeRange8.To = 80
        C1GaugeRange8.ValueColorFalloff = C1.Win.Gauge.C1GaugeValueColorFalloff.None
        C1GaugeRange8.ValueColors.AddRange(New C1.Win.Gauge.C1GaugeValueColor() {New C1.Win.Gauge.C1GaugeValueColor(0, -1, System.Drawing.Color.LightCoral, 1, CType(688069741589521705, Long)), New C1.Win.Gauge.C1GaugeValueColor(Double.NaN, 2, System.Drawing.Color.Lavender, 1, CType(688351217164156560, Long))})
        C1GaugeRange8.ViewTag = CType(687788264195372779, Long)
        C1GaugeRange8.Width = 6
        C1GaugeRange8.Width2 = 14
        Me.c1RadialGauge1.Decorators.AddRange(New C1.Win.Gauge.C1GaugeDecorator() {C1GaugeRange5, C1GaugeMarks3, C1GaugeRange6, C1GaugeRange7, C1GaugeMarks4, C1GaugeSingleLabel4, C1GaugeLabels3, C1GaugeSingleLabel5, C1GaugeLabels4, C1GaugeSingleLabel6, C1GaugeRange8})
        ...
        Me.c1RadialGauge1.MorePointers.AddRange(New C1.Win.Gauge.C1GaugePointer() {C1GaugePointer4, C1GaugePointer5, C1GaugePointer6})
