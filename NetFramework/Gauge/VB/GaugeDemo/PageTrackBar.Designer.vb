...
Partial Class PageTrackBar
    ...
    Private Sub InitializeComponent()
        ...
        Dim CommonFilling4 As C1.Win.Gauge.CommonFilling = New C1.Win.Gauge.CommonFilling
        Dim CommonFilling5 As C1.Win.Gauge.CommonFilling = New C1.Win.Gauge.CommonFilling
        Dim CommonGradient1 As C1.Win.Gauge.CommonGradient = New C1.Win.Gauge.CommonGradient
        Dim CommonGradient2 As C1.Win.Gauge.CommonGradient = New C1.Win.Gauge.CommonGradient
        ...
        Me.c1LinearGauge1.CommonFillings.AddRange(New C1.Win.Gauge.CommonFilling() {CommonFilling1, CommonFilling2, CommonFilling3, CommonFilling4, CommonFilling5})
        CommonGradient1.CenterPointX = 0.7
        CommonGradient1.CenterPointY = 0.7
        CommonGradient1.Direction = C1.Win.Gauge.C1GaugeGradientDirection.RadialOuter
        ...
        CommonGradient2.Direction = C1.Win.Gauge.C1GaugeGradientDirection.RadialOuter
        CommonGradient2.FocusScaleX = 0.2
        CommonGradient2.FocusScaleY = 0.2
        CommonGradient2.Name = "pressed"
        Me.c1LinearGauge1.CommonGradients.AddRange(New C1.Win.Gauge.CommonGradient() {CommonGradient1, CommonGradient2})
        ...
        Me.c1LinearGauge1.Decorators.AddRange(New C1.Win.Gauge.C1GaugeDecorator() {C1GaugeSingleMark1, C1GaugeSingleMark2, C1GaugeRange1, C1GaugeSingleLabel1, C1GaugeSingleLabel2, C1GaugeSingleMark3, C1GaugeSingleLabel3, C1GaugeSingleLabel4})
        ...
        Me.c1LinearGauge1.FaceShapes.AddRange(New C1.Win.Gauge.C1GaugeBaseShape() {C1GaugeRectangle1})
        Me.c1LinearGauge1.Name = "c1LinearGauge1"
        Me.c1LinearGauge1.OffPosition = 0.21
        Me.c1LinearGauge1.Pointer.Alignment = C1.Win.Gauge.C1GaugeAlignment.Center
        ...
        Me.c1LinearGauge1.Pointer.Shape = C1.Win.Gauge.C1GaugePointerShape.Round
