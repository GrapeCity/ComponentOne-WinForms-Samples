...
Partial Class PageInclined
    ...
    Private Sub InitializeComponent()
        ...
        Dim C1GaugeMarks7 As C1.Win.C1Gauge.C1GaugeMarks = New C1.Win.C1Gauge.C1GaugeMarks
        Dim C1GaugeLabels5 As C1.Win.C1Gauge.C1GaugeLabels = New C1.Win.C1Gauge.C1GaugeLabels
        Dim C1GaugeMarks8 As C1.Win.C1Gauge.C1GaugeMarks = New C1.Win.C1Gauge.C1GaugeMarks
        Dim C1GaugeMarks9 As C1.Win.C1Gauge.C1GaugeMarks = New C1.Win.C1Gauge.C1GaugeMarks
        Dim C1GaugeLabels6 As C1.Win.C1Gauge.C1GaugeLabels = New C1.Win.C1Gauge.C1GaugeLabels
        ...
        C1GaugeRange5.ValueColors.AddRange(New C1.Win.C1Gauge.C1GaugeValueColor() {New C1.Win.C1Gauge.C1GaugeValueColor(0, -1, System.Drawing.Color.Blue, 1, CType(636558699764029463, Long)), New C1.Win.C1Gauge.C1GaugeValueColor(25, -1, System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(128, Byte), Integer), CType(CType(255, Byte), Integer)), 1, CType(636840174740750120, Long)), New C1.Win.C1Gauge.C1GaugeValueColor(50, -1, System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(192, Byte), Integer), CType(CType(0, Byte), Integer)), 1, CType(637121649717460776, Long)), New C1.Win.C1Gauge.C1GaugeValueColor(75, -1, System.Drawing.Color.FromArgb(CType(CType(128, Byte), Integer), CType(CType(128, Byte), Integer), CType(CType(255, Byte), Integer)), 1, CType(637403124694171432, Long)), New C1.Win.C1Gauge.C1GaugeValueColor(100, -1, System.Drawing.Color.Red, 1, CType(637684599670882088, Long))})
        ...
        C1GaugeRange6.Filling.BrushType = C1.Win.C1Gauge.C1GaugeBrushType.None
        ...
        C1GaugeMarks8.ValueColors.AddRange(New C1.Win.C1Gauge.C1GaugeValueColor() {New C1.Win.C1Gauge.C1GaugeValueColor(0, -1, System.Drawing.Color.White, 1, CType(639091974554465369, Long)), New C1.Win.C1Gauge.C1GaugeValueColor(Double.NaN, 100, System.Drawing.Color.Purple, 1, CType(639373449531306033, Long))})
        ...
        Me.c1LinearGauge1.Decorators.AddRange(New C1.Win.C1Gauge.C1GaugeDecorator() {C1GaugeRange5, C1GaugeRange6, C1GaugeMarks7, C1GaugeLabels5, C1GaugeMarks8, C1GaugeMarks9, C1GaugeLabels6})
        ...
        Me.c1LinearGauge1.Pointer.Shape = C1.Win.C1Gauge.C1GaugePointerShape.Custom
