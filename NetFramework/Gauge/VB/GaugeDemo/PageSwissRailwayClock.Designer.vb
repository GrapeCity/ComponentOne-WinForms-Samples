...
Partial Class PageSwissRailwayClock
    ...
    Private Sub InitializeComponent()
        ...
        Me.c1RadialGauge1.Decorators.AddRange(New C1.Win.C1Gauge.C1GaugeDecorator() {C1GaugeMarks1, C1GaugeMarks2, C1GaugeSingleMark1, C1GaugeSingleMark2, C1GaugeSingleMark3})
        ...
        Me.c1RadialGauge1.FaceShapes.AddRange(New C1.Win.C1Gauge.C1GaugeBaseShape() {C1GaugeEllipse1})
        ...
        C1GaugePointer3.Shape = C1.Win.C1Gauge.C1GaugePointerShape.Rectangle
        C1GaugePointer3.Value = 17
        C1GaugePointer3.ViewTag = CType(635709843158236236, Long)
        C1GaugePointer3.Width = 2.5
        Me.c1RadialGauge1.MorePointers.AddRange(New C1.Win.C1Gauge.C1GaugePointer() {C1GaugePointer1, C1GaugePointer2, C1GaugePointer3})
