...
Partial Class PageMultithreaded
    ...
    Private Sub InitializeComponent()
        ...
        Dim C1GaugeSingleLabel6 As C1.Win.Gauge.C1GaugeSingleLabel = New C1.Win.Gauge.C1GaugeSingleLabel
        Dim C1GaugeSingleLabel7 As C1.Win.Gauge.C1GaugeSingleLabel = New C1.Win.Gauge.C1GaugeSingleLabel
        Dim C1GaugeRange2 As C1.Win.Gauge.C1GaugeRange = New C1.Win.Gauge.C1GaugeRange
        Dim C1GaugeSingleLabel8 As C1.Win.Gauge.C1GaugeSingleLabel = New C1.Win.Gauge.C1GaugeSingleLabel
        Dim C1GaugeSingleLabel9 As C1.Win.Gauge.C1GaugeSingleLabel = New C1.Win.Gauge.C1GaugeSingleLabel
        ...
        C1GaugeSingleLabel6.ValueColorFalloff = C1.Win.Gauge.C1GaugeValueColorFalloff.None
        C1GaugeSingleLabel6.ValueColors.AddRange(New C1.Win.Gauge.C1GaugeValueColor() {New C1.Win.Gauge.C1GaugeValueColor(0, -1, System.Drawing.Color.CornflowerBlue, 1, CType(673717850602170323, Long)), New C1.Win.Gauge.C1GaugeValueColor(Double.NaN, 0, System.Drawing.Color.White, 0, CType(673999326115721684, Long))})
        ...
        C1GaugeSingleLabel7.ValueColorFalloff = C1.Win.Gauge.C1GaugeValueColorFalloff.None
        C1GaugeSingleLabel7.ValueColors.AddRange(New C1.Win.Gauge.C1GaugeValueColor() {New C1.Win.Gauge.C1GaugeValueColor(0, -1, System.Drawing.Color.White, 0, CType(674280801592380936, Long)), New C1.Win.Gauge.C1GaugeValueColor(Double.NaN, 1, System.Drawing.Color.IndianRed, 1, CType(674562276824086177, Long))})
        ...
        C1GaugeRange2.ValueColorFalloff = C1.Win.Gauge.C1GaugeValueColorFalloff.None
        C1GaugeRange2.ValueColors.AddRange(New C1.Win.Gauge.C1GaugeValueColor() {New C1.Win.Gauge.C1GaugeValueColor(0, -1, System.Drawing.Color.CornflowerBlue, 1, CType(675688185048714551, Long)), New C1.Win.Gauge.C1GaugeValueColor(Double.NaN, 0, System.Drawing.Color.LimeGreen, 1, CType(675969660391416140, Long)), New C1.Win.Gauge.C1GaugeValueColor(Double.NaN, 1, System.Drawing.Color.IndianRed, 1, CType(676251135433310524, Long))})
        ...
        C1GaugeSingleLabel10.OrthogonalAlignment = C1.Win.Gauge.C1GaugeAlignment.[In]
        ...
        C1GaugeSingleMark2.Gradient.Direction = C1.Win.Gauge.C1GaugeGradientDirection.RadialOuter
        ...
        C1GaugeSingleMark2.ValueColors.AddRange(New C1.Win.Gauge.C1GaugeValueColor() {New C1.Win.Gauge.C1GaugeValueColor(Double.NaN, 0, System.Drawing.Color.CornflowerBlue, 1, CType(677658542811202374, Long)), New C1.Win.Gauge.C1GaugeValueColor(50, -1, System.Drawing.Color.White, 1, CType(677940017979483988, Long)), New C1.Win.Gauge.C1GaugeValueColor(Double.NaN, 1, System.Drawing.Color.IndianRed, 1, CType(678221493208209058, Long))})
        C1GaugeSingleMark2.ViewTag = CType(677377064084777247, Long)
        C1GaugeSingleMark2.Width = 9
        Me.c1LinearGauge1.Decorators.AddRange(New C1.Win.Gauge.C1GaugeDecorator() {C1GaugeMarks3, C1GaugeMarks4, C1GaugeLabels2, C1GaugeSingleLabel6, C1GaugeSingleLabel7, C1GaugeRange2, C1GaugeSingleLabel8, C1GaugeSingleLabel9, C1GaugeSingleLabel10, C1GaugeSingleMark2})
        ...
        C1GaugeRectangle2.Gradient.Falloff = C1.Win.Gauge.C1GaugeGradientFalloff.SigmaBell
        ...
        C1GaugePointer3.Shape = C1.Win.Gauge.C1GaugePointerShape.Triangle
        ...
        C1GaugePointer4.Shape = C1.Win.Gauge.C1GaugePointerShape.Triangle
        C1GaugePointer4.SweepTime = 6
        C1GaugePointer4.Value = 60
        C1GaugePointer4.ViewTag = CType(640503760658591088, Long)
        Me.c1LinearGauge1.MorePointers.AddRange(New C1.Win.Gauge.C1GaugePointer() {C1GaugePointer3, C1GaugePointer4})
        ...
        Me.c1LinearGauge1.Pointer.Filling.BrushType = C1.Win.Gauge.C1GaugeBrushType.None
        Me.c1LinearGauge1.Pointer.Length = 15
        Me.c1LinearGauge1.Pointer.Offset = 33
        Me.c1LinearGauge1.Pointer.Shape = C1.Win.Gauge.C1GaugePointerShape.Rectangle
