...
Namespace FilterInCode
	Partial Public Class Form1
		...
		Public Sub New()
			...
			Dim filter As C1.Olap.C1OlapFilter = olap.Fields("ProductName").Filter
			filter.Clear()
			...
			filter.Condition1.Parameter = New Date(1996, 1, 1)
			filter.Condition2.Operator = C1.Olap.ConditionOperator.LessThanOrEqualTo
			filter.Condition2.Parameter = New Date(1996, 12, 31)
