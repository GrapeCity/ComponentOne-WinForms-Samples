...
namespace Direct2DEffects
{
    public partial class MainForm : Form
    {
        ...
        void effectsCombo_SelectionChangeCommitted(object sender, EventArgs e)
        {
            var item = (EffectItem)effectsCombo.SelectedItem;
        ...
        void ClearGdiBitmap()
        {
            if (_lastGdiBitmap != null)
            {
                pictureBox1.Image = null;
                _lastGdiBitmap.Dispose();
                _lastGdiBitmap = null;
            }
        }
