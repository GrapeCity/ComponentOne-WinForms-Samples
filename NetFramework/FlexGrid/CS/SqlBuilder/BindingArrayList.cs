...
//
// This class is a better DataSource than plain ArrayList because
// it implements notifications and allows sorting.
//
//------------------------------------------------------------------
using System;
	...
	public class BindingArrayList : ArrayList, IBindingList, ITypedList, IComparer
	{
		...
		private class BindingArrayListPropertyDescriptor : PropertyDescriptor
		{
			...
			override public void SetValue(object obj, object value)
			{
                ...
                if (value is string)
                {
                    value = _pd.Converter.ConvertFromInvariantString((string)value);
                }
