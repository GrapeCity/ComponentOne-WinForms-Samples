...
Namespace C1.Win.C1FlexGrid
    Public Class PreviewForm
        ...
        Private _grid As Global.C1.Win.C1FlexGrid.C1FlexGrid

        ''' <summary>
        ''' Creates a new instance of the PrintFrom class.
        ''' </summary>
        Public Sub New(ByVal grid As Global.C1.Win.C1FlexGrid.C1FlexGrid)
            _grid = grid
            Init()
        End Sub
        ...
        Friend Property Grid() As Global.C1.Win.C1FlexGrid.C1FlexGrid
            Get
                Return _grid
            End Get
            Set(ByVal value As Global.C1.Win.C1FlexGrid.C1FlexGrid)
                _grid = value
            End Set
        End Property
