...
Namespace C1.Win.C1FlexGrid
    ...
    Public Class C1FlexGridPrintable
        ...
        ''' <returns></returns>
        Friend Shared Function SelectExportFile( _
        ByVal parent As Form, ByVal availableProviders As Global.C1.C1Preview.Export.ExportProvider(), _
        ...
        ByVal exportParameters As ExportParameters) As Global.C1.C1Preview.Export.Exporter
            ...
            If exporterType.Name = "XlsExporter" Then
                ...
                If (onePagePerSheetProperty IsNot Nothing) AndAlso _
                    onePagePerSheetProperty.PropertyType Is Type.GetType("System.Boolean") AndAlso _
        ...
        Private Function DoShowOptionsDialog(ByRef exporter As Global.C1.C1Preview.Export.Exporter, _
