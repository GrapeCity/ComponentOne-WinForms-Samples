...
1) AutomaticDelay = zero,
so tips are shown as soon as the mouse enters the controls (no delay), and
   
2) AutoPopDelay = int.MaxValue,
so tips are not hidden even if the mouse stays over a cell for a long time.
