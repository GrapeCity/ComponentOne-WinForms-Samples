Module Data
    ...
    Function GetDataSource() As DataTable
        ...
        dt.Columns.Add("HP", GetType(Integer))
        dt.Columns.Add("Liter", GetType(Double))
        dt.Columns.Add("Cylinder", GetType(Integer))
        dt.Columns.Add("TransmissionSpeedCount", GetType(Integer))
        dt.Columns.Add("AutomaticTransmission", GetType(Boolean))
        dt.Columns.Add("Category")
        dt.Columns.Add("StartSaleDate", GetType(DateTime))
