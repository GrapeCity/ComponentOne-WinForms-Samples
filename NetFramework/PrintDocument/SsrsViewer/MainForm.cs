...
namespace SsrsViewer
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            c1PrintPreviewControl1.PreviewPane.PropertyChanged += PreviewPane_PropertyChanged;
            UpdateControls();
        }
        ...
        void chkSearchToolBar_Click(object sender, EventArgs e)
        {
            if (chkSearchToolBar.Checked)
                c1PrintPreviewControl1.TextSearchUIStyle = C1.Win.C1Preview.TextSearchUIStyle.ToolBar;
            else
                c1PrintPreviewControl1.TextSearchUIStyle = C1.Win.C1Preview.TextSearchUIStyle.Panel;
        }
