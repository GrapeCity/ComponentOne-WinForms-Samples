...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents C1ToolBar1 As C1.Win.Command.C1ToolBar
    Friend WithEvents C1CommandLink44 As C1.Win.Command.C1CommandLink
    Friend WithEvents C1CommandLink45 As C1.Win.Command.C1CommandLink
    Friend WithEvents C1CommandLink46 As C1.Win.Command.C1CommandLink
    Friend WithEvents C1CommandControl1 As C1.Win.Command.C1CommandControl
    Friend WithEvents findTextCombo As System.Windows.Forms.ComboBox
    Friend WithEvents cmdFind As C1.Win.Command.C1Command
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.C1ToolBar1 = New C1.Win.Command.C1ToolBar
        Me.C1CommandHolder1 = New C1.Win.Command.C1CommandHolder
        Me.C1CommandControl1 = New C1.Win.Command.C1CommandControl
        Me.findTextCombo = New System.Windows.Forms.ComboBox
        Me.cmdFind = New C1.Win.Command.C1Command
        ...
        Me.RichTextBox1.Location = New System.Drawing.Point(0, 71)
        Me.RichTextBox1.Name = "RichTextBox1"
        Me.RichTextBox1.Size = New System.Drawing.Size(624, 372)
        ...
        Me.C1MainMenu1.Size = New System.Drawing.Size(624, 22)
        ...
        Me.C1CommandDock1.Controls.Add(Me.Format)
        Me.C1CommandDock1.Controls.Add(Me.tbFile)
        Me.C1CommandDock1.Controls.Add(Me.tbEdit)
        Me.C1CommandDock1.Id = 1
        Me.C1CommandDock1.Location = New System.Drawing.Point(0, 22)
        Me.C1CommandDock1.Name = "C1CommandDock1"
        Me.C1CommandDock1.Size = New System.Drawing.Size(624, 49)
        '
        'C1ToolBar1
        '
        Me.C1ToolBar1.CommandHolder = Me.C1CommandHolder1
        Me.C1ToolBar1.CommandLinks.Add(Me.C1CommandLink46)
        Me.C1ToolBar1.CommandLinks.Add(Me.C1CommandLink44)
        Me.C1ToolBar1.Controls.Add(Me.findTextCombo)
        Me.C1ToolBar1.Location = New System.Drawing.Point(0, 24)
        Me.C1ToolBar1.Name = "C1ToolBar1"
        Me.C1ToolBar1.Size = New System.Drawing.Size(260, 25)
        ...
        'C1CommandControl1
        '
        Me.C1CommandControl1.Control = Me.findTextCombo
        Me.C1CommandControl1.Name = "C1CommandControl1"
        '
        'findTextCombo
        '
        Me.findTextCombo.Location = New System.Drawing.Point(63, 2)
        Me.findTextCombo.Name = "findTextCombo"
        Me.findTextCombo.Size = New System.Drawing.Size(167, 21)
        Me.findTextCombo.TabIndex = 0
        Me.findTextCombo.TabStop = False
        '
        'cmdFind
        '
        Me.cmdFind.ImageIndex = 3
        Me.cmdFind.Name = "cmdFind"
        Me.cmdFind.Shortcut = System.Windows.Forms.Shortcut.F3
        Me.cmdFind.Text = "Search"
        '
        'C1CommandLink46
        '
        Me.C1CommandLink46.ButtonLook = C1.Win.Command.ButtonLookFlags.Text
        Me.C1CommandLink46.Command = Me.C1CommandControl1
        Me.C1CommandLink46.Text = "Find text:"
        Me.C1CommandLink46.ToolTipText = "Find text"
        '
        'C1CommandLink44
        '
        Me.C1CommandLink44.Command = Me.cmdFind
        Me.C1CommandLink44.Text = "Find again"
        Me.C1CommandLink44.ToolTipText = "Find again"
        '
        'Format
        '
        ...
        Me.C1ToolBar1.ResumeLayout(False)
...
#End Region
    ...
    Private Sub findTextCombo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles findTextCombo.KeyDown
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As C1.Win.Command.ClickEventArgs) Handles cmdFind.Click
        doFind()
    End Sub

    Private Sub doFind()
        If findTextCombo.Text.Length > 0 And findTextCombo.FindStringExact(findTextCombo.Text) < 0 Then
            findTextCombo.Items.Add(findTextCombo.Text)
        End If
        Dim res As Integer = -1
        Try
            res = Me.RichTextBox1.Find(findTextCombo.Text, Me.RichTextBox1.SelectionStart + 1, RichTextBoxFinds.None)
        Catch ex As Exception
            ' ignore - consider not found
        End Try
        If res = -1 Then
    ...
    Private Sub RichTextBox1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles RichTextBox1.KeyDown
        If e.KeyData = (Keys.Control Or Keys.D) Then
            Me.findTextCombo.Focus()
        End If
    End Sub
End Class
