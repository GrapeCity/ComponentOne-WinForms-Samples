...
<Assembly: EdmSchemaAttribute("6ad13335-2d6f-4e7e-9e48-2e1848d311f5")>
#Region "EDM Relationship Metadata"
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "FK_Products_Categories", "Categories", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(Category), "Products", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Product), True)>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "FK_Orders_Customers", "Customers", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(Customer), "Orders", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Order), True)>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "FK_Employees_Employees", "Employees", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(Employee), "Employees1", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Employee), True)>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "FK_Orders_Employees", "Employees", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(Employee), "Orders", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Order), True)>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "FK_Order_Details_Orders", "Orders", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.One, GetType(Order), "Order_Details", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Order_Detail), True)>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "FK_Order_Details_Products", "Products", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.One, GetType(Product), "Order_Details", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Order_Detail), True)>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "FK_Orders_Shippers", "Shippers", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(Shipper), "Orders", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Order), True)>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "FK_Products_Suppliers", "Suppliers", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(Supplier), "Products", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Product), True)>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "FK_Territories_Region", "Region", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.One, GetType(Region), "Territories", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Territory), True)>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "CustomerCustomerDemo", "CustomerDemographics", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(CustomerDemographic), "Customers", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Customer))>
<Assembly: EdmRelationshipAttribute("NORTHWNDModel", "EmployeeTerritories", "Employees", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Employee), "Territories", System.Data.Entity.Core.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Territory))>
