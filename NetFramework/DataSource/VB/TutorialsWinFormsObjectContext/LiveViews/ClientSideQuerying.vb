...
Public Class ClientSideQuerying
    ...
    Private _seafoodProductsView As ClientView(Of TutorialsWinForms.Product)
    ...
    Public Sub New()
        ...
        _viewProducts =
            (From p In _scope.GetItems(Of TutorialsWinForms.Product)()
        ...
        _seafoodProductsView = _scope.GetItems(Of TutorialsWinForms.Product)().AsFiltered(Function(p) p.CategoryID.HasValue AndAlso p.CategoryID.Value = 8)
