...
Public Class DataSourcesInCode
    ...
    Public Sub New()
        ...
        Dim viewCategories As ClientView(Of TutorialsWinForms.Category) = _scope.GetItems(Of TutorialsWinForms.Category)()
    ...
    Private Sub BindGrid(categoryID As Integer)
        dataGridView1.DataSource =
                (From p In _scope.GetItems(Of TutorialsWinForms.Product)().AsFiltered(Function(p As TutorialsWinForms.Product) p.CategoryID.HasValue AndAlso p.CategoryID.Value = categoryID)
                 Select New With
                 {
                     p.ProductID,
                     p.ProductName,
