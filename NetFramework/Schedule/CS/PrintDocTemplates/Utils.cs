...
namespace PrintDocTemplates
{
    ...
    public static class Utils
    {
        ...
        private static void AddHeadersFooters(C1PrintDocument doc)
        {
            ...
            doc.Tags.Add(newTag);
            newTag = new Tag("HeaderColor", Color.Black, typeof(System.Drawing.Color));
            doc.Tags.Add(newTag);
            newTag = new Tag("FooterColor", Color.Black, typeof(System.Drawing.Color));
            doc.Tags.Add(newTag);
        ...
        public static void MakeDetails(C1PrintDocument doc)
        {
            ...
            rt.Style.BackColor = Color.LightGray;
