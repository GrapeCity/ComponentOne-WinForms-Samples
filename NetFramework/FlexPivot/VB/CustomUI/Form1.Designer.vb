Namespace CustomUI
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
            ...
            CType(Me.c1FlexPivotGrid1, System.ComponentModel.ISupportInitialize).BeginInit()
            CType(Me.c1FlexPivotPanel1, System.ComponentModel.ISupportInitialize).BeginInit()
            CType(Me.c1FlexPivotChart1, System.ComponentModel.ISupportInitialize).BeginInit()
			Me.SuspendLayout()
			' 
			' splitContainer1
			' 
			...
			' 
            Me.splitContainer1.Panel1.Controls.Add(Me.c1FlexPivotGrid1)
			' 
			' splitContainer1.Panel2
			' 
            Me.splitContainer1.Panel2.Controls.Add(Me.c1FlexPivotChart1)
...
'			Me.toolStripButton5.Click += New System.EventHandler(Me._btnReport_Click)
			...
			' panel1
			' 
            Me.panel1.Controls.Add(Me.c1FlexPivotPanel1)
            ...
            Me.label1.Text = "My Custom FlexPivot Application"
			' 
            ' c1FlexPivotGrid1
			' 
            ...
            Me.c1FlexPivotGrid1.Location = New Point(0, 0)
            Me.c1FlexPivotGrid1.Margin = New Padding(4)
            Me.c1FlexPivotGrid1.Name = "c1FlexPivotGrid1"
            Me.c1FlexPivotGrid1.Rows.Count = 1
            Me.c1FlexPivotGrid1.Rows.DefaultSize = 24
            ...
            ' c1FlexPivotPanel1
			' 
            Me.c1FlexPivotPanel1.Anchor = (CType((AnchorStyles.Top Or AnchorStyles.Right), AnchorStyles))
            Me.c1FlexPivotPanel1.Location = New Point(576, 15)
            Me.c1FlexPivotPanel1.Margin = New Padding(5, 6, 5, 6)
            Me.c1FlexPivotPanel1.Name = "c1FlexPivotPanel1"
            Me.c1FlexPivotPanel1.ShowZeros = False
            Me.c1FlexPivotPanel1.Size = New Size(319, 355)
            Me.c1FlexPivotPanel1.TabIndex = 2
            Me.c1FlexPivotPanel1.Visible = False
			' 
            ' c1FlexPivotChart1
			' 
            Me.c1FlexPivotChart1.BackColor = Color.Transparent
            Me.c1FlexPivotChart1.DataSource = Me.c1FlexPivotPanel1
            Me.c1FlexPivotChart1.Dock = DockStyle.Fill
            Me.c1FlexPivotChart1.Location = New Point(0, 0)
            Me.c1FlexPivotChart1.Margin = New Padding(4)
            Me.c1FlexPivotChart1.Name = "c1FlexPivotChart1"
            Me.c1FlexPivotChart1.ShowTitle = False
            Me.c1FlexPivotChart1.Size = New Size(405, 449)
            Me.c1FlexPivotChart1.TabIndex = 1
			' 
            ' c1FlexPivotPrintDocument1
			' 
            Me.c1FlexPivotPrintDocument1.FooterText = Nothing
            Me.c1FlexPivotPrintDocument1.FlexPivotChart = Me.c1FlexPivotChart1
            Me.c1FlexPivotPrintDocument1.FlexPivotGrid = Me.c1FlexPivotGrid1
            Me.c1FlexPivotPrintDocument1.RawDataGrid = Nothing
			' 
			' Form1
			' 
            ...
            Me.Text = "C1FlexPivot: Custom User Interface"
'			Me.Load += New System.EventHandler(Me.Form1_Load)
            ...
            CType(Me.c1FlexPivotGrid1, System.ComponentModel.ISupportInitialize).EndInit()
            CType(Me.c1FlexPivotPanel1, System.ComponentModel.ISupportInitialize).EndInit()
            CType(Me.c1FlexPivotChart1, System.ComponentModel.ISupportInitialize).EndInit()
