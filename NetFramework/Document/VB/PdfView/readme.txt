...
This sample is built around a form with a C1.Win.FlexViewer.C1FlexViewer controll, and a C1.Win.Document.C1PdfDocumentSource component assigned to its DocumentSource property.
