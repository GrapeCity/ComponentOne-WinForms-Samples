...
using C1.Win.FlexChart.Designer.Utils;
...
namespace C1.Win.FlexChart.Designer.UI
{
    internal partial class DataMap : UserControl
    {
        ...
        public void InitBindings(Chart.FlexChartBase chart)
        {
            tableLayoutPanel1.SuspendLayout();
        ...
        void InitBindings(Chart.FlexChart chart)
        {
