...
namespace C1.Win.FlexChart.Designer.UI
{
    partial class PropertiesPanel : UserControl
    {
        ...
        void UpdateBindings(Chart.FlexChart chart)
        {
        ...
        void UpdateBindings(Chart.FlexPie chart)
        {
            var binds = dataMap.Bindings;
            var bndn = binds["Name"];
            if (bndn.Count > 0)
        ...
        private Image GetImage(string text)
        {
            if (text == "Chart")
            {
                if (chart is Chart.FlexChart)
                    text = "ColumnChart";
                else if (chart is Chart.FlexPie)
                    text = "PieChart";
            }
            return global::C1.Win.FlexChart.Designer.Properties.Resources.ResourceManager.GetObject(text) as Image;
        }
        ...
        public Chart.FlexChartBase Chart
        {
            get { return chart; }
            set
            {
