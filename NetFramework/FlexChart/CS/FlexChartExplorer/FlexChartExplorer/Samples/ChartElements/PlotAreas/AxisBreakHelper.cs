...
namespace AxisBreak
{
    ...
    public class AxisBreakHelper
    {
        ...
        class AxisBreak
        {
            ...
            {
                this.axis = axis;
                chart = (C1.Win.Chart.FlexChart)axis.Chart;
            ...
            void CreatePlotAreas(double min1, double max1, double min2, double max2, double size, double gapPixels)
            {
                ...
                {
                    var pa1 = new PlotArea() { Column = 0, Name = "pa1", Width = new GridLength(size, GridUnitType.Star) };
                    var paBreak = new PlotArea() { Column = 1, Name = "pabreak", Width = new GridLength(gapPixels) };
                ...
                {
                    var pa1 = new PlotArea() { Row = 2, Name = "pa1", Height = new GridLength(size, GridUnitType.Star) };
                    var paBreak = new PlotArea() { Row = 1, Name = "pabreak", Height = new GridLength(gapPixels) };
            ...
            void CreateSeries()
            {
                // 1st color from current palette
                color = Color.FromArgb((int)((IPalette)chart).GetColor(0));
                ...
                ser2.Style.FillColor = ser2.Style.StrokeColor = color;
            ...
            {
                if(axis2!=null)
                    DrawAxisBreak(e.Engine, axis, axis2, color);
            }

            private void DrawAxisBreak(IRenderEngine e, Axis axis1, Axis axis2, Color clr)
            {
            ...
            { 
                ...
                engine.SetFill(chart.BackColor.ToArgb());
                ...
                engine.SetStroke(chart.ForeColor.ToArgb());
