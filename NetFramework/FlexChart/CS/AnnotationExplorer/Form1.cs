using AnnotationExplorer.Samples;
using System;
...
namespace AnnotationExplorer
{
    public partial class MainForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (str)
            {
                case "BASIC": newControl = new Basic(); break;
                case "ADVANCED": newControl = new Advanced(); break;
                case "CALLOUTS": newControl = new Callouts(); break;
                default: newControl = new Basic(); break;
            }
