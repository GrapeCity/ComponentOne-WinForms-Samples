...
namespace C1WordsX
{
    ...
    public class C1TextEditorRibbon : C1.Win.C1Ribbon.C1Ribbon
    {
        ...
        RecentDocumentList  _mru;               // recent document list
        ...
        void _parent_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            settings.RecentDocuments = _mru.RecentDocuments;
        ...
        bool PrintDocument(bool selectPrinter, bool showPreview)
        {
            if (!showPreview)
            {
        ...
        void InitApplicationMenu()
        {
            ...
            // right menu items
            _mru = new RecentDocumentList(this);

            // bottom menu items
            items = menu.BottomPaneItems;
            items.ClearAndDisposeItems();
            RibbonButton btnExit = CreateButton("Exit");
            items.Add(btnExit);
        }
