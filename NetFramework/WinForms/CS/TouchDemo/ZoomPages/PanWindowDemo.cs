...
namespace TouchToolKitDemo.C1ZoomPages
{
    public partial class PanWindowDemo : DemoBase
    {
        ...
        private void InitializeDemo()
        {
            ...
            this.Description = @"This page is used to show the pan window. You can use the pan window to see the entire form and scroll the owner form quickly by clicking/dragging your mouse or finger.";
