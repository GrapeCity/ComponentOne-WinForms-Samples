...
namespace ControlExplorer.RulesManager.Presets
{
    public class StylePresets
    {
        ...
        private static Dictionary<DataBar, ItemStyle> gradientDataBarsDictionary = null;
        private static Dictionary<DataBar, ItemStyle> solidDataBarsDictionary = null;
        private static Dictionary<ColorScale, ItemStyle> colorScalesDictionary = null;
        private static Dictionary<IconSet, ItemStyle> iconSetsDictionary = null;
        ...
        public static Dictionary<DataBar, ItemStyle> GradientDataBars
        {
            get
            {
                if (gradientDataBarsDictionary == null)
                {
                    gradientDataBarsDictionary = GetDataBarGradient();
                }

                return gradientDataBarsDictionary;
            }
        }
        ...
        public static Dictionary<DataBar, ItemStyle> SolidDataBars
        {
            get
            {
                if (solidDataBarsDictionary == null)
                {
                    solidDataBarsDictionary = GetDataBarSolid();
                }

                return solidDataBarsDictionary;
            }
        }
        ...
        public static Dictionary<ColorScale, ItemStyle> ColorScales
        {
            get
            {
                if (colorScalesDictionary == null)
                {
                    colorScalesDictionary = GetColorScale();
                }

                return colorScalesDictionary;
            }
        }
        ...
        public static Dictionary<IconSet, ItemStyle> IconSets
        {
            get
            {
                if (iconSetsDictionary == null)
                {
                    iconSetsDictionary = GetIconSet();
                }

                return iconSetsDictionary;
            }
        }
