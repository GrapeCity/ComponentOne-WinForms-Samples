...
namespace ControlExplorer.Editor
{
    public partial class RTFEditor : C1DemoForm
    {
        ...
        private void ribbonButton1_Click(object sender, EventArgs e)
        {
            ...
            using (var fs = File.Open(AppDomain.CurrentDomain.BaseDirectory + "Resources\\Rich_Text_Format.rtf", FileMode.Open))
            {
                c1Editor1.LoadRtf(fs, null);
            }
        }
        ...
        private void ribbonButton6_Click_1(object sender, EventArgs e)
        {
            ...
            using (var fs = File.Open(AppDomain.CurrentDomain.BaseDirectory + "Resources\\test.rtf", FileMode.Open))
            {
                c1Editor1.LoadRtf(fs, null);
            }
        }
