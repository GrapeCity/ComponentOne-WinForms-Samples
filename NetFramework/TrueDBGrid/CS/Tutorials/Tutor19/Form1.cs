...
namespace Tutorial_19
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private Tutorial_19.dsCustomers1 dsCustomers11;
		...
		private void InitializeComponent()
		{
			...
			((System.ComponentModel.ISupportInitialize)(this.dsCustomers11)).BeginInit();
			this.SuspendLayout();
			// 
			// c1TrueDBGrid1
			// 
			...
			this.c1TrueDBGrid1.DataSource = this.dsCustomers11;
			...
			this.c1TrueDBGrid1.PropBag = "<?xml version=\"1.0\"?><Blob><DataCols><C1DataColumn Level=\"0\" Caption=\"Company\" Da" +
				...
				" 17, 476, 323</ClientRect><BorderSide>0</BorderSide><CaptionStyle parent=\"Style2" +
				...
				"a>0, 0, 476, 340</ClientArea><PrintPageHeaderStyle parent=\"\" me=\"Style42\" /><Pri" +
				"ntPageFooterStyle parent=\"\" me=\"Style43\" /></Blob>";
			// 
			// dsCustomers11
			// 
			this.dsCustomers11.DataSetName = "dsCustomers1";
			this.dsCustomers11.Locale = new System.Globalization.CultureInfo("en-US");
			this.dsCustomers11.Namespace = "http://www.tempuri.org/dsCustomers1.xsd";
			// 
			// oleDbDataAdapter1
			// 
			...
			this.Controls.AddRange(new System.Windows.Forms.Control[] {
																		  ...
																		  this.c1TrueDBGrid1});
			this.Name = "Form1";
			this.Text = "Tutorial 19";
			this.Load += new System.EventHandler(this.Form1_Load);
			((System.ComponentModel.ISupportInitialize)(this.c1TrueDBGrid1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.dsCustomers11)).EndInit();
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				this.oleDbDataAdapter1.Fill(this.dsCustomers11);
			}
			catch
			{
