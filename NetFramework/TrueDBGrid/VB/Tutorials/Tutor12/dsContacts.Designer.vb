...
Partial Public Class dsContacts
    ...
    Partial Public Class ContactsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddContactsRow(ByVal FirstName As String, ByVal LastName As String, ByVal CustType As Short, ByVal Callback As Boolean, ByVal Comments As String, ByVal ContactDate As Date, ByVal ContactType As Short, ByVal UserCode As String, ByVal Company As String, ByVal Contacted As Date, ByVal Phone As Double, ByVal Expr1 As String) As ContactsRow
            Dim rowContactsRow As ContactsRow = CType(Me.NewRow,ContactsRow)
            Dim columnValuesArray() As Object = New Object() {FirstName, LastName, CustType, Callback, Comments, ContactDate, ContactType, UserCode, Company, Contacted, Phone, Expr1}
    ...
    Partial Public Class ContactsRow
        ...
        Public Sub SetContactedNull()
            Me(Me.tableContacts.ContactedColumn) = Global.System.Convert.DBNull
        End Sub
