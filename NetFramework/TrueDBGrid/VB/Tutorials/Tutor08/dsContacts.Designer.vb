...
Partial Public Class dsContacts
    ...
    Partial Public Class ContactsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddContactsRow(ByVal FirstName As String, ByVal LastName As String, ByVal CustType As Short, ByVal Callback As Boolean, ByVal Comments As String, ByVal ContactDate As Date, ByVal ContactType As Short, ByVal Company As String, ByVal Expr1 As Double, ByVal UserCode As String, ByVal Expr2 As String) As ContactsRow
            Dim rowContactsRow As ContactsRow = CType(Me.NewRow,ContactsRow)
            Dim columnValuesArray() As Object = New Object() {FirstName, LastName, CustType, Callback, Comments, ContactDate, ContactType, Company, Expr1, UserCode, Expr2}
