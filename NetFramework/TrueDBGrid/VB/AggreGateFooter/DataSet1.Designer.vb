...
Partial Public Class DataSet1
    ...
    Partial Public Class CustomersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCustomersRow(ByVal CustomerID As String, ByVal Country As String, ByVal ContactTitle As String, ByVal ContactName As String, ByVal CompanyName As String, ByVal City As String) As CustomersRow
            Dim rowCustomersRow As CustomersRow = CType(Me.NewRow,CustomersRow)
            Dim columnValuesArray() As Object = New Object() {CustomerID, Country, ContactTitle, ContactName, CompanyName, City}
