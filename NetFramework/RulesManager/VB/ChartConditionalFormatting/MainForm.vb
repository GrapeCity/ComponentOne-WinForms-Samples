...
#Region "Initialization"
    ...
    Private Sub MainForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        Dim horizontalScrollbar = New AxisScrollbar(formattableFlexChart.AxisX)
    ...
    Private Sub ApplyPredefinedRules()
        Dim rule1 = New C1.Win.RulesManager.Rule() With {
            .Name = "Product rating",
            .Expression = "= true",
        ...
        Dim rule2 = New C1.Win.RulesManager.Rule() With {
...
#Region "DataSource"
    ...
    Private Function GetDataSource() As DataTable
        Dim rs = "select top 9 * from Products where UnitsInStock > 0 and UnitsOnOrder > 0 "
