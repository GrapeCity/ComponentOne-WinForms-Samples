...
namespace Routes
{
    ...
    public partial class MapUserControl : UserControl
    {
        ...
        public MapUserControl(SourceMaps.ITileSource source)
        {
            ...
            centerHereToolStripMenuItem.Image = Properties.Resources.Center;
        }
        ...
        protected virtual void InitMap(SourceMaps.ITileSource source = null)
        {
            if (Map is null)
            {
                // Start init.
                _map = new C1Map();
                ((ISupportInitialize)_map).BeginInit();
                SuspendLayout();

                // Basic properties.
                _map.Dock = DockStyle.Fill;
                _map.DistanceScale.Alignment = ContentAlignment.BottomLeft;
                ...
                _map.PanTool.MarkerStyle.GradientStyle = GradientStyle.Vertical;

                _map.PanTool.PanStyle.BackColor = _toolbarLigthColor;
                _map.PanTool.PanStyle.BackColor2 = _toolbarDarkColor;
                _map.PanTool.PanStyle.GradientStyle = GradientStyle.Vertical;

                _map.PanTool.PanStyle.Stroke.Color = _toolbarDarkColor;

                // Zoom options.
                _map.ZoomTool.Margin = new Padding(20, 70, 0, 0);
                ...
                // End init.
                ((ISupportInitialize)_map).EndInit();
                ResumeLayout(false);
