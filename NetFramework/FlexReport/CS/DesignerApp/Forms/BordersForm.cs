...
namespace FlexReportDesignerApp
{
    ...
    public partial class BordersForm : System.Windows.Forms.Form
    {
        ...
        private void cbBorderAll_Click(object sender, EventArgs e)
        {
            ...
            Border.Color = (Color)c1ColorPicker1.Value;
            RefreshPreview();
        }
        ...
        private void cbBorder_Click(object sender, EventArgs e)
        {
            ...
            if (((C1.Win.C1Input.C1CheckBox)sender).Checked)
            {
                ...
                line.Color = (Color)c1ColorPicker1.Value;
            }
            else
            {
        ...
        {
            Func<Rectangle, C1.Win.C1Input.C1CheckBox, bool> testClickBorder = (rect_, cb_) =>
            {
