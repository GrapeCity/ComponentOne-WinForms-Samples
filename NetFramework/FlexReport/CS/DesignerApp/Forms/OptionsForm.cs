...
namespace FlexReportDesignerApp
{
    ...
    public partial class OptionsForm : System.Windows.Forms.Form
    {
        ...
        {
            get { return (Color)_cpRubberBandBase.Value; }
            set { _cpRubberBandBase.Value = (Color)value; }
        }
        public Color SelectionBaseColor
        {
            get { return (Color)_cpSelectionBase.Value; }
            set { _cpSelectionBase.Value = (Color)value; }
        }
        public Color MouseGuidesBaseColor
        {
            get { return (Color)_cpMouseGuidesBase.Value; }
            set { _cpMouseGuidesBase.Value = (Color)value; }
        }
        public Color BrickBoundsBaseColor
        {
            get { return (Color)_cpBrickBoundsBase.Value; }
            set { _cpBrickBoundsBase.Value = (Color)value; }
        }
        public Color GridBaseColor
        {
            get { return (Color)_cpGridBase.Value; }
            set { _cpGridBase.Value = (Color)value; }
        }
        public Color RulerBaseColor
        {
            get { return (Color)_cpRulerBase.Value; }
            set { _cpRulerBase.Value = (Color)value; }
        }
        public Color ControlBaseColor
        {
            get { return (Color)_cpControlBase.Value; }
            set { _cpControlBase.Value = (Color)value; }
        }
        public Color CaptionBaseColor
        {
            get { return (Color)_cpCaptionBase.Value; }
            set { _cpCaptionBase.Value = (Color)value; }
        }
        public Color IndicatorBaseColor
        {
            get { return (Color)_cpIndicatorBase.Value; }
            set { _cpIndicatorBase.Value = (Color)value; }
        }
        public Color HighlightBaseColor
        {
            get { return (Color)_cpHighlightBase.Value; }
            set { _cpHighlightBase.Value = (Color)value; }
        }
        #endregion
