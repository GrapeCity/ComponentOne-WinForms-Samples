...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim panelElement9 As New C1.Win.Tile.PanelElement()
            Dim imageElement8 As New C1.Win.Tile.ImageElement()
            Dim textElement5 As New C1.Win.Tile.TextElement()
            Dim imageElement9 As New C1.Win.Tile.ImageElement()
            Dim panelElement10 As New C1.Win.Tile.PanelElement()
            Dim panelElement11 As New C1.Win.Tile.PanelElement()
            Dim panelElement12 As New C1.Win.Tile.PanelElement()
            Dim imageElement10 As New C1.Win.Tile.ImageElement()
            Dim textElement6 As New C1.Win.Tile.TextElement()
            Dim panelElement13 As New C1.Win.Tile.PanelElement()
            Dim panelElement14 As New C1.Win.Tile.PanelElement()
            Dim panelElement15 As New C1.Win.Tile.PanelElement()
            Dim imageElement11 As New C1.Win.Tile.ImageElement()
            Dim textElement7 As New C1.Win.Tile.TextElement()
            Dim panelElement16 As New C1.Win.Tile.PanelElement()
            Dim imageElement12 As New C1.Win.Tile.ImageElement()
            Dim textElement8 As New C1.Win.Tile.TextElement()
            Dim imageElement13 As New C1.Win.Tile.ImageElement()
            Dim imageElement14 As New C1.Win.Tile.ImageElement()
            Me.c1CmdDock = New C1.Win.Command.C1CommandDock()
            Me.dockTabPagePreview = New C1.Win.Command.C1DockingTab()
            Me.dockTabPageRptList = New C1.Win.Command.C1DockingTabPage()
            Me.pnlRpts = New System.Windows.Forms.Panel()
            Me.c1tileCntrl = New C1.Win.Tile.C1TileControl()
            Me.tileGrp = New C1.Win.Tile.Group()
            Me._reportDefaultTemplate = New C1.Win.Tile.Template()
            Me._reportSelectedTemplate = New C1.Win.Tile.Template()
            Me._tileSelectedTemplate = New C1.Win.Tile.Template()
            Me._tileLineTemplate = New C1.Win.Tile.Template()
            ...
            Me.dockTabPagePreview.CloseBox = C1.Win.Command.CloseBoxPositionEnum.ActivePage
            ...
            Me.dockTabPagePreview.TabLook = C1.Win.Command.ButtonLookFlags.Text
            Me.dockTabPagePreview.TabsCanFocus = False
            Me.dockTabPagePreview.TabSizeMode = C1.Win.Command.TabSizeModeEnum.Fit
            Me.dockTabPagePreview.TabsShowFocusCues = False
            Me.dockTabPagePreview.TabsSpacing = 5
            Me.dockTabPagePreview.TabStyle = C1.Win.Command.TabStyleEnum.Office2007
            Me.dockTabPagePreview.VisualStyle = C1.Win.Command.VisualStyle.Office2007Blue
            Me.dockTabPagePreview.VisualStyleBase = C1.Win.Command.VisualStyle.Office2007Blue
            ' 
            ' dockTabPageRptList
            ' 
            ...
            Me.c1tileCntrl.Orientation = C1.Win.Tile.LayoutOrientation.Vertical
            ...
            Me._reportDefaultTemplate.BackColorSelector = C1.Win.Tile.BackColorSelector.Unbound
            ...
            Me._reportSelectedTemplate.BackColorSelector = C1.Win.Tile.BackColorSelector.Unbound
            ...
            textElement8.BackColorSelector = C1.Win.Tile.BackColorSelector.Unbound
            ...
            imageElement13.ImageSelector = C1.Win.Tile.ImageSelector.Image1
            ...
            imageElement14.ImageLayout = C1.Win.Tile.ForeImageLayout.Stretch
            imageElement14.ImageSelector = C1.Win.Tile.ImageSelector.Unbound
...
#End Region
        ...
        Private c1CmdDock As C1.Win.Command.C1CommandDock
        Private dockTabPagePreview As C1.Win.Command.C1DockingTab
        Private dockTabPageRptList As C1.Win.Command.C1DockingTabPage
        Private pnlRpts As System.Windows.Forms.Panel
        Private c1tileCntrl As C1.Win.Tile.C1TileControl
        Private tileGrp As C1.Win.Tile.Group
        Private _reportDefaultTemplate As C1.Win.Tile.Template
        Private pnlTabShowHide As System.Windows.Forms.Panel
        Private pbTabShowHide As System.Windows.Forms.PictureBox
        Private _tileSelectedTemplate As C1.Win.Tile.Template
        ...
        Private _tileLineTemplate As C1.Win.Tile.Template
        Private _reportSelectedTemplate As C1.Win.Tile.Template
    End Class
End Namespace
