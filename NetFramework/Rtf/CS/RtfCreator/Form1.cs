...
namespace RtfCreator
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		public Form1()
		{
            ...
            Debug.Assert(_format.Equals(".docx"));
#else
		...
		private void InitializeComponent()
		{
            ...
            this._groupRead.Text = "Read documents";
            // 
            // label1
            // 
            ...
            // _statusBar
            // 
            this._statusBar.Location = new System.Drawing.Point(0, 460);
            ...
            this.Text = "C1Rtf (MS Word compatible) Demo Creater";
		...
		{
			// create document
			C1RtfDocument c1rtf = new C1RtfDocument();
			c1rtf.Info.Title = "Simple sample";
			_statusBar.Text = "Creating document...";

			Font font = new Font("Tahoma", 24, FontStyle.Italic);
            c1rtf.AddParagraph("Hello World!", font, Color.Blue);

			_statusBar.Text = "Saving document...";
            string fileName = GetFileName(c1rtf, "simple.rtf");
			c1rtf.Save(fileName);
		...
		private void _tbPicture_Click(object sender, System.EventArgs e)
		{
			...
			// create document
			C1RtfDocument c1rtf = new C1RtfDocument();
			c1rtf.Info.Title = "Show any picture sample";
			_statusBar.Text = "Creating document...";

			Font font = new Font("Arial", 14, FontStyle.Bold);
            c1rtf.AddParagraph("Picture:", font, Color.Chocolate);
			...
			c1rtf.AddPicture(img, RtfAlignmentEnum.Left);

			c1rtf.LineBreak();

			font = new Font("Arial", 10, FontStyle.Regular);
            c1rtf.AddParagraph(dlg.FileName, font, Color.Blue);

			_statusBar.Text = "Saving document...";
            string fileName = GetFileName(c1rtf, "picture.rtf");
			c1rtf.Save(fileName);
			Process.Start(fileName);
			_statusBar.Text = "Ready.";
		}
		...
		private void _btTable_Click(object sender, System.EventArgs e)
		{
			// create document
			C1RtfDocument c1rtf = new C1RtfDocument();
			c1rtf.Info.Title = "Sample with tables";
			_statusBar.Text = "Creating document...";
            ...
            c1rtf.AddParagraph("Simple table.", font, Color.Blue);

			_statusBar.Text = "Saving document...";
            string fileName = GetFileName(c1rtf, "table.rtf");
			c1rtf.Save(fileName);
			Process.Start(fileName);
			_statusBar.Text = "Ready.";
		}
		...
		private void _btFonts_Click(object sender, System.EventArgs e)
		{
			// create document
			C1RtfDocument c1rtf = new C1RtfDocument();
			c1rtf.Info.Title = "All Fonts";
			_statusBar.Text = "Creating document...";

			// add title
            c1rtf.AddParagraph(c1rtf.Info.Title, new Font("Tahoma", 24, FontStyle.Bold), Color.Black);
			...
			foreach (FontFamily ff in ifc.Families)
			{
				...
				// show font
                c1rtf.AddParagraph(ff.Name, font, Color.Black);
                c1rtf.AddParagraph("The quick brown fox jumped over the lazy dog. 1234567890!", sample, Color.Black);
				sample.Dispose();
...
//				c1rtf.PageBreak();
			...
			_statusBar.Text = "Saving document...";
            string fileName = GetFileName(c1rtf, "fonts.rtf");
			c1rtf.Save(fileName);
			Process.Start(fileName);
			_statusBar.Text = "Ready.";
		}
		...
		private void _btGraphics_Click(object sender, System.EventArgs e)
		{
            ...
            c1rtf.DrawString("Graphics sample", font, Color.DeepPink, rc, sf);

			c1rtf.DrawLine(Pens.Green, 200, 190, 400, 190);

			rc = new RectangleF(150, 150, 190, 80);
            using (Pen pen = new Pen(Brushes.Blue, 5.0f))
            {
                c1rtf.DrawRectangle(pen, rc);
            }
			c1rtf.FillRectangle(Color.Gold, rc);
			c1rtf.ShapeFillOpacity(50);
			c1rtf.ShapeRotation(25);

			rc = new RectangleF(300, 150, 80, 80);
			c1rtf.DrawEllipse(Pens.Red, rc);
            c1rtf.FillEllipse(Color.Pink, rc);
			c1rtf.ShapeFillOpacity(70);
			...
			c1rtf.DrawPolyline(Pens.BlueViolet, pts);
            ...
            c1rtf.DrawString("Vertical", font, Color.Black, rc, sf);
			...
			c1rtf.DrawBeziers(Pens.HotPink, pts);

			_statusBar.Text = "Saving document...";
            string fileName = GetFileName(c1rtf, "graphics.rtf");
			c1rtf.Save(fileName);
			Process.Start(fileName);
			_statusBar.Text = "Ready.";
		}
		...
		private void _btMetafile_Click(object sender, System.EventArgs e)
		{
			...
			// create document
			C1RtfDocument c1rtf = new C1RtfDocument();
			c1rtf.Info.Title = "Convert metafile to RTF example";
			_statusBar.Text = "Creating document...";
			...
			c1rtf.DrawMetafile((Metafile)img);
			...
			Font font = new Font("Arial", 10, FontStyle.Regular);
            c1rtf.AddParagraph(dlg.FileName, font, Color.Black);

			_statusBar.Text = "Saving document...";
            string fileName = GetFileName(c1rtf, "metafile.rtf");
			c1rtf.Save(fileName);
			Process.Start(fileName);
			_statusBar.Text = "Ready.";
		}
		...
		private void _btCurve_Click(object sender, System.EventArgs e)
		{
			// create document
			C1RtfDocument c1rtf = new C1RtfDocument();
			c1rtf.Info.Title = "Various curves sample";
			_statusBar.Text = "Creating document...";
			...
			c1rtf.DrawString("Curves sample", font, Color.Black, rc, sf);
            ...
            //c1rtf.FillPie(Brushes.Yellow, rc, 0, 90);
            //c1rtf.DrawPie(Pens.Indigo, rc, 0, 90);

            // arc
            rc = new RectangleF(120, 100, 150, 80);
            c1rtf.DrawArc(Pens.Red, rc, 0, 90);

            //// arc
            //rc = new RectangleF(320, 300, 90, 45);
            //c1rtf.DrawArc(Pens.Blue, rc, 270, 90);

			_statusBar.Text = "Saving document...";
            string fileName = GetFileName(c1rtf, "curves.rtf");
			c1rtf.Save(fileName);
			Process.Start(fileName);
			_statusBar.Text = "Ready.";
		}
		...
		private void _btRead_Click(object sender, System.EventArgs e)
		{
			...
			c1rtf.Load(dlg.FileName);

			_statusBar.Text = "Saving document...";
            string fileName = GetFileName(c1rtf, "reading.rtf");
			c1rtf.Save(fileName);
			Process.Start(fileName);
			_statusBar.Text = "Ready.";
		}
		...
		string GetFileName(C1RtfDocument c1rtf, string fileName)
		{
            c1rtf.Info.Author = "C1RtfCreator";
            c1rtf.Info.Company = "GrapeCity";
            ...
            {
                c1rtf.ShapesWord2007Compatible = true;
            }
