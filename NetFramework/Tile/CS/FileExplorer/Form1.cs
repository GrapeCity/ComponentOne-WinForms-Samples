    ...
    public partial class Form1 : Form
    {
                ...
                foreach (DriveInfo drive in DriveInfo.GetDrives())
                {
                    ...
                    switch (dt)
                    {
                        case DriveType.CDRom:
                            tile.Image = FileExplorer.Properties.Resources.mediaDrive;
                            break;
                        case DriveType.Fixed:
                            tile.Image = FileExplorer.Properties.Resources.hardDrive;
                            break;
                        case DriveType.Network:
                            tile.Image = FileExplorer.Properties.Resources.networkDrive;
                            break;
                        default:
                            tile.Image = FileExplorer.Properties.Resources.otherDrive;
                            break;
                    }
        ...
        void ShowDirectory(DirectoryInfo dirInfo, bool keepOffset)
        {
            ...
            try
            {
                ...
                foreach (DirectoryInfo subDir in dirInfo.GetDirectories())
                {
                    ...
                    tile.Image = FileExplorer.Properties.Resources.folder;
                ...
                foreach (FileInfo file in dirInfo.GetFiles())
                {
                    ...
                    tile.Image = FileExplorer.Properties.Resources.file;
                    tile.Text = file.Name;
        ...
        void tempDrive_Paint(object sender, TemplatePaintEventArgs e)
        {
            ...
            if (di != null)
            {
                ...
                float factor = g.DpiY / 96f;
                rc.X = (int)(rc.X * factor + 0.5f);
                rc.Y = (int)(rc.Y * factor + 0.5f);
                rc.Width = (int)(rc.Width * factor + 0.5f);
                rc.Height = (int)(rc.Height * factor + 0.5f);
